...
INSERT INTO responsavel (nome, sobrenome, email, telefone, cpf, endereco, genero, dt_nasc) VALUES ('Carlos', 'Santos', 'carlos.santos@example.com', '11987654321', '12345678902', 1, 'Masculino', '1970-02-02');
INSERT INTO responsavel (nome, sobrenome, email, telefone, cpf, endereco, genero, dt_nasc) VALUES ('Ana', 'Costa', 'ana.costa@example.com', '11912345678', '10987654322', 2, 'Feminino', '1980-03-03');

-- Inserindo dados em paciente
INSERT INTO paciente (nome, sobrenome, email, cpf, genero, telefone, responsavel, dt_nasc, endereco, dt_entrada, dt_saida, cns) VALUES ('Pedro', 'Lima', 'pedro.lima@example.com', '12345678903', 'Masculino', '11987654322', 1, '2000-04-04', 1, '2024-01-01', '2024-06-01', '123456789123456');
