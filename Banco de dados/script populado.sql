...
('2024-12-06 09:00:00', 'Consulta de rotina', 19, 19, 1, '01:00:00'),
('2024-12-06 10:00:00', 'Consulta de rotina', 20, 20, 1, '01:00:00'),
('2024-12-06 11:00:00', 'Consulta de rotina', 21, 21, 1, '01:00:00'),
('2024-12-09 09:00:00', 'Consulta de rotina', 22, 22, 1, '01:00:00'),
...
('2024-12-06 09:00:00', 'Consulta de orientação pedagógica', 19, 19, 5, '00:40:00'),
('2024-12-06 10:00:00', 'Consulta de orientação pedagógica', 20, 20, 5, '00:40:00'),
('2024-12-07 09:00:00', 'Consulta de orientação pedagógica', 21, 21, 5, '00:40:00'),
('2024-12-07 10:00:00', 'Consulta de orientação pedagógica', 22, 22, 5, '00:40:00');


-- Inserindo dados em acompanhamento
INSERT INTO acompanhamento (resumo, relatorio, consulta_id, medico, especificacao_medica, status_consulta, paciente) 
VALUES
('Paciente colaborou bem', 'Relatório completo disponível.', 1, 1, 1, 2, 1),
('Paciente apresentou dificuldades', 'Necessário ajuste no tratamento.', 39, 2, 2, 2, 2),
('Progresso satisfatório', 'Encaminhado para avaliação.', 52, 3, 3, 1, 3),
('Paciente ausente', 'Consulta reagendada.', 107, 4, 4, 4, 4),
('Melhora evidente no quadro', 'Paciente respondeu bem à intervenção.', 120, 5, 1, 1, 5),
('Paciente mostrou resistência inicial', 'Necessário reforço em abordagens específicas.', 142, 6, 2, 2, 6),
('Progresso parcial identificado', 'Continuidade do plano de tratamento sugerida.', 177, 7, 3, 1, 7),
('Consulta realizada com sucesso', 'Paciente comunicativo e proativo.', 2, 8, 1, 1, 8),
('Paciente não colaborou', 'Necessário revisão de estratégias.', 40, 9, 4, 4, 9),
('Evolução acima do esperado', 'Resultados demonstram eficácia do tratamento.', 53, 10, 3, 1, 10),
('Paciente não compareceu', 'Consulta será reagendada.', 108, 11, 5, 4, 11),
('Paciente em progresso constante', 'Relatório enviado ao responsável.', 121, 12, 1, 1, 12);
